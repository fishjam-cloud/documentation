...
On Android, it is possible to continue streaming when app is in background. Unfortunatelly this functionality is not available on iOS (due to Apple limitations)

Below is configuraiton required to make it work:
