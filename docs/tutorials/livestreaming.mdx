...
You can use `RTCPIPView` to enable Picture in Picture, allowing viewers to watch the livestream in a floating window while using other apps. See the [Picture in Picture guide](../how-to/react-native/picture-in-picture) to learn how to enable and configure this feature.
