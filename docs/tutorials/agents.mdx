...
Agents use the [Selective Subscriptions API](/how-to/features/selective-forwarding.mdx) to allow you to define which peers/tracks they should receive audio from.
By default, agents will receive all peers' audio streams.
...
:::danger
Disconnecting the agent is important, as **every connected agent generates usage** just as a normal peer.
:::
...
- [Selective Subscriptions API](/how-to/features/selective-forwarding.mdx)
