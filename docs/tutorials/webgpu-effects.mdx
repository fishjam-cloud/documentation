...
- As before: the New Architecture and a development build
...
- See the [WebGPU effects how-to](../how-to/client/custom-sources/webgpu-effects) for the rules inside `onFrame`, platform notes, cropping helpers and troubleshooting
