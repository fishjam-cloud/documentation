...
# Tutorial: React Native Quick Start

**Tutorial** - _Learn the basics by building your first Fishjam app_
...
A simple React Native app that can join video calls and stream video between participants.

## What you'll learn

- How to install and configure Fishjam
...
Let's create a component that can join a room and start streaming video:
...
- ✅ How to install and configure Fishjam for React Native
