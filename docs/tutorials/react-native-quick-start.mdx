...
2. Copy your Fishjam ID
3. Navigate to the [Sandbox tab](https://fishjam.io/app/sandbox)
...
:::important
The iOS Simulator does not have camera access by default. To test camera features, either use a real device or use [SimCam](https://simcam.swmansion.com/) to inject a virtual camera into the simulator — see [Camera on iOS Simulator](../how-to/react-native/ios-simulator-camera).
:::
