...
If you have no WHEP player to hand, [vdo.ninja](https://vdo.ninja/whip#play) works in the browser: paste that URL into **WHEP endpoint URL** and press **GO**. You should see the race running.
