...
:::info
You don't need to explicitly ask for permissions because it is done automatically on mounting. You can opt for asking them at a different time if you want to customize the user experience.
:::
