...
The `useLivestream` hook will authorize you using the viewer token, handle the process of receiving the stream and will forward it to the `LivestreamView` component.
