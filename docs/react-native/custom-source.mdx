...
It is your responsibility to implement the JS layer. It will depend on your react-native setup. If you use expo we recommend create a [Local Expo Module](https://docs.expo.dev/modules/get-started/).
