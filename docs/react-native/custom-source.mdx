...
Checkout the [Full Example](https://github.com/fishjam-cloud/mobile-client-sdk/tree/3473afd51ff3a4dc5849463d1ff8a4028e428739/examples/vision-camera).
...
It is your resposibility to implement the JS layer. It will depened on your react-native setup. If you use expo we recommend create a [Local Expo Module](https://docs.expo.dev/modules/get-started/).
