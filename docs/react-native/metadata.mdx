...
You can also set metadata on [server side, when adding user to the room](../production/metadata.mdx). These metadata can be defined only when user is joining room and can't be
