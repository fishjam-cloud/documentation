...
The [`initializeDevices`](/api/web/functions/useInitializeDevices#initializedevices) function will return a promise of [`InitializeDevicesResult`](/api/web/type-aliases/InitializeDevicesResult).
