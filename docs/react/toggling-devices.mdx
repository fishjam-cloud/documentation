...
## Turning Cameras On and Off - `toggleCamera()`
...
## Toggling Microphones - `toggleMicrophone()` and `toggleMicrophoneMute()`

### Turning Microphones On and Off - `toggleMicrophone()`

This function toggles the microphone's physical operational state.

- **Turning the microphone off**: This stops the microphone, disables the media stream, and pauses any audio transmission.
- **Turning the microphone on**: This enables the microphone and resumes audio streaming.

### Muting and Unmuting Microphones - `toggleMicrophoneMute()`
