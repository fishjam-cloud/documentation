...
This section provides examples on how to quickly set up a livestreaming flow in React using Fishjam.  
...
To start streaming, simply [join the room](/react/connecting) and [stream as you would normally do](/react/start-streaming).
