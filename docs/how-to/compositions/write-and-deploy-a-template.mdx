...
The composition comes from [Step 1 of the tutorial](./../../tutorials/compositions#step-1-create-a-composition), the livestream and its streamer token from [Step 3](./../../tutorials/compositions#step-3-create-a-livestream-to-publish-to).
