...
Create the composition and the livestream now rather than earlier, so neither is sitting idle while you write the template: a composition with no input media deletes itself after five minutes. Take the composition from [Step 1 of the tutorial](./../../tutorials/compositions#step-1-create-a-composition) and the livestream with its streamer token from [Step 3](./../../tutorials/compositions#step-3-create-a-livestream-to-publish-to):
