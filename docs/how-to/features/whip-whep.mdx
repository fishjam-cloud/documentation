...
<Tabs groupId="language">
  ...
  <TabItem value="python" label="Python">
    ...
    streamer_token = await fishjam_client.create_livestream_streamer_token(room.id) # [!code highlight]
    ```

  </TabItem>
</Tabs>

The created streamer token should be supplied in the HTTP headers of the WHIP request:
...
<Tabs groupId="language">
  ...
  <TabItem value="python" label="Python">
    ...
    room = await fishjam_client.create_room(room_type="livestream", public=False)

    # ...

    viewer_token = await fishjam_client.create_livestream_viewer_token(room.id) # [!code highlight]
    ```

  </TabItem>
</Tabs>

The created viewer token should be supplied in the HTTP headers of the WHEP request:
...
For public livestreams, you don't need a token, however you still need a room of `livestream` type with `public` set to true.
...
<Tabs groupId="language">
  ...
  <TabItem value="python" label="Python">
    ...
    ```python
    room = await fishjam_client.create_room(room_type="livestream", public=True)
    # now you can use room.id to start viewing
    ```
