...
Sandbox API is a development tool that lets you create rooms and peers for testing without setting up your own backend server. This guide shows you how to use it effectively.
...
Below are examples on how to use the tokens from Sandbox API in your frontend applications:
...
```
// For the streamer
const streamerUrl = `https://fishjam.io/api/v1/connect/${YOUR_APP_UUID}/room-manager?roomName=liveStream&peerName=streamer&roomType=livestream`;
...
:::danger
**Sandbox API is not safe for production!**
...
Only use Sandbox API for development and testing.
:::
...
Once you've tested your integration with Sandbox API:

- [Set up your own backend](/tutorials/backend-quick-start)
- [Learn more about Sandbox API](/explanation/sandbox-api-concept)
