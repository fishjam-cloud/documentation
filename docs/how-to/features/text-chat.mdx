...
Before implementing text chat, you must be [connected to a room](../explanation/connecting). Data channels only work after you have successfully joined a room.
