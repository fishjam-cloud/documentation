...
When creating a peer, you can also assign metadata to that peer, which can be read later on with the [mobile SDK](/how-to/react-native/metadata-and-broadcasting)
