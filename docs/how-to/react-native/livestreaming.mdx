...
This guide shows you how to implement livestreaming in React Native using Fishjam.
You'll learn how to publish video streams and receive them in your app.
...
Fishjam livestreaming follows a **one-to-many** model:
...
- **One streamer** per room (streams video/audio)
...
Before you start livestreaming, you need:
...
:::note
Livestreaming rooms accept only one video track and one audio track. Fishjam ignores additional tracks to maintain video quality.
:::
