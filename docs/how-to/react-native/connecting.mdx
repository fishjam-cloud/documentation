...
with a pre-configured test service called [Room Manager](/how-to/features/room-manager-testing). This is basically a service that will create a Room, add your app as
