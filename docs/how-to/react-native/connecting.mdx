...
While using the Sandbox environment, [you can use the Sandbox API](/how-to/features/room-manager-testing) to generate peer tokens for testing or development purposes.
