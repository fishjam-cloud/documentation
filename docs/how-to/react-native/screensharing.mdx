...
If you want to continue screen sharing when the app goes to background, you need to:
...
See [background calls documentation](./background-streaming) for detailed instructions and code examples.
