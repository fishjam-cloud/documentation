...
You can get the token using the [Sandbox API](/how-to/features/room-manager-testing) if you're using the Sandbox environment, or implement your own backend service that will provide the user with a **Peer Token**.
