...
Fishjam SDK provides the [`useLivestreamViewer`](/api/web/functions/useLivestreamViewer) hook to receive the broadcasted stream.
The [`useLivestreamViewer`](/api/web/functions/useLivestreamViewer) hook will provide a [MediaStream](https://developer.mozilla.org/en-US/docs/Web/API/MediaStream) object once the connection with Fishjam is established.
