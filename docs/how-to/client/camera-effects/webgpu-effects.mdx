...
- The packages (`@fishjam-cloud/video-effects` 0.1.4 or newer) and the Babel and minimum OS configuration from [Background effects](./background-effects.mdx#install). The segmentation model and the Metro and `expo-asset` setup are not needed.
