...
Your app can ring like the phone app: an incoming call shows up as a **native call**,
full-screen on a locked phone or as a call notification while the phone is in use,
even when the app is backgrounded or killed. A push notification wakes the app, and
answering the call has it join a Fishjam room, where the call takes place.
