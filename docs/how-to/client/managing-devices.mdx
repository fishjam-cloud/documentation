...
export function CameraControls() {
  ...
  return (
    <View>
      <Button onPress={() => startCamera()} title="Start Camera" disabled={isCameraOn} />
      <Button onPress={() => stopCamera()} title="Stop Camera" disabled={!isCameraOn} />
    </View>
  );
}
```
...
export function MicrophoneControls() {
  ...
  return (
    <View>
      <Button onPress={() => startMicrophone()} title="Start Microphone" disabled={isMicrophoneOn} />
      <Button onPress={() => stopMicrophone()} title="Stop Microphone" disabled={!isMicrophoneOn} />
    </View>
  );
}
```
