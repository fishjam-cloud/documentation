...
The example assumes you've already installed [**our SDK**](https://github.com/fishjam-cloud/js-server-sdk) and you're ready to go.  
...
[**Read more **](https://fastify.dev/docs/latest/Reference/Plugins) for a deeper understanding of the concept.
