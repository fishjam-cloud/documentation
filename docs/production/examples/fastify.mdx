...
In this case, we don't need to extend any interfaces, because the plugin doesn't decorate the Fastify instance with any properties. It will work in the background.
