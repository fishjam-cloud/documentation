...
Livestream rooms are **cheaper** than conference rooms for equivalent usage, because there is only one broadcaster.
...
| ----------------------------------- | ---------- | ---------------------------------------- |
| Video meetings with 2-10 people     | Conference | Bidirectional video, screen sharing      |
| Large video conference (10+ people) | Conference | Multi-participant support                |
...
| Interactive workshop                | Conference | Participant engagement, screen sharing   |
