...
- **All variants** (default): Omit `sentQualities` or pass `[VARIANT_LOW, VARIANT_MEDIUM, VARIANT_HIGH]`
- **Subset**: Pass only the variants you need, e.g. `[VARIANT_LOW, VARIANT_HIGH]`
