...
The **Sandbox API URL** is the room manager endpoint. React/React Native SDK helpers such `useSandbox({ sandboxApiUrl })` call this URL to create rooms and obtain peer, streamer, or viewer tokens.
