...
_Understanding what Sandbox API is and why it exists_

Sandbox API is a development tool that simplifies getting started with Fishjam by providing a simple backend for testing, eliminating the need to build your own server initially.

## What can Sandbox API do?

Sandbox API is an HTTP server that comes with Fishjam's Sandbox environment.
...
Sandbox API mitigates this issue and allows you to start frontend development ASAP.

## Relationship to Server SDKs

Sandbox API is essentially a simplified application built using the Fishjam Server SDKs:
...
To understand how to use Sandbox API for development:

- [How to use Sandbox API for testing](/how-to/features/room-manager-testing)
