...
- **Media flow**: Peer-to-peer through media server
...
- **Cost**: 75% cheaper than conference rooms

### Livestream Rooms

- **Purpose**: One-to-many livestreaming
- **Media flow**: Single streamer sends media to multiple viewers
- **Protocols**: Uses [WHEP/WHIP](https://blog.swmansion.com/building-interactive-streaming-apps-webrtc-whip-whep-explained-d38f4825ec90) standards for viewers/streamers
- **Scaling**: Optimized for high viewer counts
- **Cost**: 20% cheaper than conference rooms
