...
**Explanation** - *Understanding how Fishjam works under the hood*
...
### Latency
- **P2P-style**: < 100ms between participants
- **Livestream**: < 500ms broadcaster to viewer
- **Geographic optimization**: Edge servers reduce latency

### Quality
- **Adaptive bitrate**: Automatically adjusts to network conditions
- **Quality controls**: Client-side quality management
- **Hardware acceleration**: Uses device capabilities when available
