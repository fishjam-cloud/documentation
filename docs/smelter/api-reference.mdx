...
- [OpenAPI specification](https://github.com/fishjam-cloud/documentation/tree/main/static/api/smelter-cloud-openapi.yaml)

:::note Preview specification
This reference is a preview and is maintained by hand while the generated specification is being finalized. If a detail here disagrees with the live API, treat the live API as authoritative and let us know.
:::
