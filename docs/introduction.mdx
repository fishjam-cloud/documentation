...
2. Once you have an account, Fishjam Cloud will assign you a sandbox instance automatically. Sandbox instances come with [**Room Manager**](/guide/room-manager.md) - a simple backend for creating test rooms. Copy the _Fishjam URL_ and _Management Token_ from the developer panel.
