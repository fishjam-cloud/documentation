...
For both web and mobile, the easiest way to get started is with Video Room, a simple video room application that demonstrates video and audio streaming with Fishjam. Check out the code here:
