...
description: The Smelter Cloud Composition API, REST reference, the WebSocket event stream, and the authentication model.
---

# Composition API

[Smelter Cloud](../smelter/what-is-smelter-cloud) exposes the Composition API: a REST API for managing compositions, plus a WebSocket stream for engine events. All requests go to `https://rtc.fishjam.io`.
