...
:::important
The iOS Simulator has no camera. To test camera features, use a real device or [SimCam](https://simcam.swmansion.com/), which injects a virtual camera the simulator picks up automatically. See [Camera on iOS Simulator](../how-to/react-native/ios-simulator-camera).
:::
