...
The iOS Simulator does not have a real camera. Use [SimCam](https://simcam.swmansion.com/) to inject a virtual camera feed — your Mac's camera or a video file — so you can test camera selection and streaming without a physical device. See [Camera on iOS Simulator](../../how-to/react-native/ios-simulator-camera).
:::
