...
>
  <div style={{ flex: 1}}>
    <p>
      Ready-to-run example applications for web and mobile. Most useful when
      you want to see Fishjam in action or use a project as a starting point.
    </p>

  </div>
    <div style={{ flex: 1, display: "flex", justifyContent: "flex-end" }}>
      <ul style={{ listStyle: "none", textAlign: "right" }}>
      <li>[React Examples](./examples/react.mdx)</li>
      <li>[React Native Examples](./examples/react-native.mdx)</li>
    </ul>
