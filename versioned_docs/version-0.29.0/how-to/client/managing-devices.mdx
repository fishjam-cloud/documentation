...
To select the desired camera, use the [`selectCamera`](../../api/mobile/functions/useCamera) method.
The list of the available camera devices is available via the [`cameraDevices`](../../api/mobile/functions/useCamera).
...
You can use [`toggleCamera`](../../api/mobile/functions/useCamera) to toggle the camera state, or use [`startCamera`](../../api/mobile/functions/useCamera) and [`stopCamera`](../../api/mobile/functions/useCamera) for more explicit control.
